document.getElementById('checkButton').addEventListener('click', function() {
    ...
    const khodams = [
        ...
        'Burung Elang Merah', 'Laba-laba Biru', 'Kalajengking Merah', 'Ikan Pari Hitam', 'Burung Hantu Emas', 'Kadal Bekasi', 'Knalpot Nmax', 'Gergaji Mesin', 'Monyet Jawa', 'Kudanil Afrika', 'Mama Lemon', 'Sunlight Sabun Pencuci Piring', 'Minyak Bimoli', 'Terasi Mentah', 'Spion Scoopy', 'Monyet Papua', 'Sepatu Cak Imin', 'Babi',  'kerbau India',
    ];
